...
import 'package:lingu/datasources/implementations/pronunciation_assessment/pronunciation_assessment_errors.dart';
import 'package:lingu/datasources/implementations/pronunciation_assessment/pronunciation_assessment_dto.dart';
import 'package:lingu/datasources/implementations/pronunciation_assessment/pronunciation_assessment_mapper.dart';
...
class LinuxPronunciationAssessmentService implements IPronunciationAssessmentService {
  ...
  static Future<LinuxPronunciationAssessmentService> create({
    ...
    String binaryPath = 'lib/datasources/implementations/pronunciation_assessment/linux/python/pc_pronunciation/dist/main',
  }) async {
  ...
  Future<PronunciationAssessmentResult> assessFromWavAsync(
    ...
    try {
      ...
      if (responseJson['success'] == true) {
        final dto = PronunciationAssessmentDto.fromMap(responseJson['data']);
        return PronunciationAssessmentMapper.toEntity(dto);
      } else {
