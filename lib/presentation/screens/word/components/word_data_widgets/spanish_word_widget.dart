...
class SpanishWordWidget extends StatefulWidget {
  final SpanishWord word;
  final WordViewController controller;
  const SpanishWordWidget({super.key, required this.word, required this.controller});

  @override
  State<SpanishWordWidget> createState() => _SpanishWordWidgetState();
}

class _SpanishWordWidgetState extends State<SpanishWordWidget> with SignalsMixin {
