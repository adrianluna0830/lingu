...
class EnglishWordWidget extends StatefulWidget {
  final EnglishWord word;
  final WordViewController controller;
  const EnglishWordWidget({super.key, required this.word, required this.controller});

  @override
  State<EnglishWordWidget> createState() => _EnglishWordWidgetState();
}

class _EnglishWordWidgetState extends State<EnglishWordWidget> with SignalsMixin {
