...
class STTCredentialsView extends StatefulWidget {
  final VoidCallback onComplete;
  final bool isSetupFlow;

  const STTCredentialsView({
    super.key,
  ...
  @override
  State<STTCredentialsView> createState() => _STTCredentialsViewState();
}

class _STTCredentialsViewState extends State<STTCredentialsView> with SignalsMixin {
  ...
  void initState() {
    super.initState();
    final existingKey = di<STTCredentialsService>().apiKey.value;
  ...
  Future<void> _validateAndContinue() async {
    ...
    di<STTCredentialsService>().apiKey.value = _apiKeyController.text;
    final fabric = di<IAPIFabric<ISpeechToTextService>>();
            ...
            Watch((context) {
              return TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'Speech-to-Text API Key',
